...
mhc=c("HLA-DRA","HLA-DRB1",  "HLA-DPA1","HLA-DMA","HLA-DMB","HLA-DPB1","CD74", "CTSS") #"HLA-DQA1", "HLA-DRB5", "HLA-DQA2", "HLA-DQB1", "HLA-DQB2",
#"HLA-DOA", "HLA-DOB") 
...
ggsave(plt, filename=paste("dge_antigen_presentation_mhc2.png"), width=13, height =13)
ggsave(plt, filename=paste("dge_antigen_presentation_mhc2.pdf"), width=13, height =13, device = cairo_pdf, dpi=200)
